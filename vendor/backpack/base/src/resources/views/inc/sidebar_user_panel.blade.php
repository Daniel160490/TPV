<div class="user-panel">
  ...
  <div class="pull-left info">
    ...
    <small><small><a href="{{ route('backpack.account.info') }}"><span><i class="fa fa-user-circle-o"></i> Mi Cuenta</span></a> &nbsp;  &nbsp; <a href="{{ backpack_url('logout') }}"><i class="fa fa-sign-out"></i> <span>Salir</span></a></small></small>
  </div>
</div>