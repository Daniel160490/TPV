        ...
        <form class="form" action="{{ route('backpack.account.info') }}" method="post">
            ...
            <div class="box">
                ...
                <div class="box-footer">
                    ...
                    <button type="submit" class="btn btn-success"><span class="ladda-label"><i class="fa fa-save"></i> Guardar</span></button>
                    <a href="{{ backpack_url() }}" class="btn btn-default"><span class="ladda-label">Cancelar</span></a>
